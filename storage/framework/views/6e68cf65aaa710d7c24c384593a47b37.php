        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('account')); ?>">Login</a>
              </li>
          </ul>
        </div>
        <form class="d-flex">
...
</html><?php /**PATH C:\SEMESTER3\front-end\UAS\UAS_FRONTEND_PROGAMMING_KELOMPOK10\example-app\resources\views/home.blade.php ENDPATH**/ ?>