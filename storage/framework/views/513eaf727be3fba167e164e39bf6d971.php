      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('subscribe')); ?>">Subscribe</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(route('account')); ?>">SignIn</a>
            </li>
          </ul>
        </div>
        <form class="d-flex">
...
<?php /**PATH C:\SEMESTER3\front-end\UAS\UAS_FRONTEND_PROGAMMING_KELOMPOK10\example-app\resources\views/account.blade.php ENDPATH**/ ?>